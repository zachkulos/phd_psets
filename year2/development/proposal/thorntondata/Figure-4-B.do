...
* Rename variables for those who have any incentive.
rename ESTFCT anyESTFCT
rename ESTFCT_u anyESTFCT_u
rename ESTFCT_l anyESTFCT_l
keep  xgrid anyESTFCT anyESTFCT_u anyESTFCT_l
sort xgrid
save someincentivegraph, replace




* do for those with no incentive
use nonparametricvct.dta, clear
...
rename ESTFCT zeroESTFCT
rename ESTFCT_u zeroESTFCT_u
rename ESTFCT_l zeroESTFCT_l
keep  xgrid zeroESTFCT zeroESTFCT_u zeroESTFCT_l
sort xgrid

* Merge with the respondents who got an incentive
merge xgrid using someincentivegraph



* Figure 4 Panel B
twoway (line anyESTFCT xgrid, sort clcolor(navy))  (line anyESTFCT_u xgrid, sort clcolor(navy)) (line anyESTFCT_l xgrid, sort clcolor(navy) )   (line zeroESTFCT xgrid, sort clpat (dash) clcolor(maroon))  (line zeroESTFCT_u xgrid, sort clpat(dash) clcolor(maroon)) (line zeroESTFCT_l xgrid, sort clpat(dash) clcolor(maroon) xtitle("Distance to VCT(KM)") ytitle("   ")legend(order(4 "No Incentive" 2 "Some Incentive")) xlabel(0 1 2 3 4  ) ), saving(Figure4b)
